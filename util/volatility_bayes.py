...
def train_volatility_model(df):
    """
    Train a Bayesian logistic regression model to predict the likelihood of price volatility.
    ...
    # Build Bayesian logistic regression model - using scikit-learn's built-in Bayesian implementation
    # with Tikhonov regularization (aka L2, aka ridge) which approximates a Gaussian prior
    model = LogisticRegression(
        penalty='l2',             # L2 regularization (Bayesian prior)
        C=1.0,                    # Inverse of regularization strength
        solver='lbfgs',           # Preferred solver for logistic regression
